...
<body>
	<!-- navigation -->
	<nav class="pages-nav">
		<div class="pages-nav__item"><a class="link link--page" href="#page-home">Equipamentos</a></div>
		<div class="pages-nav__item"><a class="link link--page" href="#page-docu">Setores</a></div>
		<div class="pages-nav__item"><a class="link link--page" href="#page-manuals">Inventário</a></div>
		<div class="pages-nav__item"><a class="link link--page" href="#page-software">Resumo</a></div>
		<div class="pages-nav__item"><a class="link link--page" href="#page-custom">Preferências &amp; Configurações</a></div>
		<div class="pages-nav__item"><a class="link link--page" href="#page-training">Sistema de Chamados</a></div>
	...
	<div class="pages-stack">
		...
		<div class="page" id="page-docu">
			<header class="bp-header cf">
				<h1 class="bp-header__title">Setores</h1>
